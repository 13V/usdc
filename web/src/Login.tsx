...
const FRAME_OUTER =
  "position:relative; width:100%; max-width:430px; margin:0 auto; min-height:100vh; background:#0B1622; overflow:hidden; font-family:'General Sans',sans-serif; color:#F4F7FA; -webkit-font-smoothing:antialiased; display:flex; flex-direction:column;";
...
function connectingHtml(headline: string, status: string): string {
  return `<div style="${FRAME_OUTER} align-items:center; justify-content:center;">
    ...
    <div data-act="home" style="position:absolute; top:34px; left:16px; z-index:6;"><div style="width:36px; height:36px; border-radius:50%; background:rgba(244,247,250,0.05); border:1px solid rgba(244,247,250,0.08); display:flex; align-items:center; justify-content:center; cursor:pointer;"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(244,247,250,0.5)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18M6 6l12 12"/></svg></div></div>
    <div style="position:relative; z-index:2; width:200px; height:200px; display:flex; align-items:center; justify-content:center;">
      ...
      <svg width="184" height="184" viewBox="0 0 184 184" style="position:absolute; left:50%; top:50%; transform:translate(-50%,-50%); overflow:visible;"><defs><linearGradient id="cgArc" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#2775CA"></stop><stop offset="100%" stop-color="#3DE8C7"></stop></linearGradient></defs><circle cx="92" cy="92" r="88" fill="none" stroke="rgba(127,192,255,0.12)" stroke-width="5"></circle><circle cx="92" cy="92" r="88" fill="none" stroke="url(#cgArc)" stroke-width="5" stroke-linecap="round" stroke-dasharray="150 553" style="transform-box:fill-box; transform-origin:center; animation:cgSpin 1.4s linear infinite; filter:drop-shadow(0 0 5px rgba(61,232,199,0.55));"></circle></svg>
      <div style="position:relative; width:130px; height:130px; animation:cgFloat 3.4s ease-in-out infinite;">
        ...
        <div style="position:absolute; left:50%; top:50%; transform:translate(-50%,-50%); width:116px; height:116px; background:linear-gradient(155deg,#4aa0f0,#2775CA 60%,#1c5697); animation:cgSquish 5s ease-in-out infinite; box-shadow:0 16px 32px rgba(6,14,24,0.5), inset 0 6px 13px rgba(255,255,255,0.32), inset 0 -8px 16px rgba(13,40,72,0.5); display:flex; align-items:center; justify-content:center;">
          ...
          <div style="display:flex; gap:18px; margin-top:-12px;"><div style="width:13px; height:18px; border-radius:50%; background:#0B1622; animation:cgBlink 4.5s infinite;"></div><div style="width:13px; height:18px; border-radius:50%; background:#0B1622; animation:cgBlink 4.5s infinite;"></div></div>
          <div style="position:absolute; bottom:38px; left:50%; transform:translateX(-50%); width:24px; height:12px; background:#0B1622; border-radius:5px 5px 12px 12px; overflow:hidden; display:flex; align-items:flex-end; justify-content:center;"><div style="width:13px; height:8px; background:#FF6B5E; border-radius:3px 3px 6px 6px; margin-bottom:-1px;"></div></div>
        </div>
      </div>
    </div>
    ...
    <h1 style="position:relative; z-index:2; font-family:'Clash Display','General Sans',sans-serif; font-weight:600; font-size:30px; letter-spacing:-0.8px; margin:12px 0 0; color:#F4F7FA; text-align:center; padding:0 30px;">${headline}</h1>
    <div style="position:relative; z-index:2; height:22px; margin-top:16px; display:flex; align-items:center; justify-content:center;"><div style="display:flex; align-items:center; gap:8px;"><span style="width:7px; height:7px; border-radius:50%; background:#3DE8C7; box-shadow:0 0 8px rgba(61,232,199,0.8);"></span><span style="font-family:'Space Mono',monospace; font-size:12.5px; letter-spacing:.2px; color:rgba(244,247,250,0.6);">${status}</span></div></div>
    <div style="position:absolute; bottom:64px; left:0; right:0; z-index:2; text-align:center;">
      <div style="font-family:'Space Mono',monospace; font-size:10.5px; letter-spacing:.5px; color:rgba(244,247,250,0.35);">this only happens once</div>
      <div data-act="restart" style="font-family:'Space Mono',monospace; font-size:10.5px; letter-spacing:.3px; color:rgba(244,247,250,0.4); margin-top:14px; cursor:pointer;">taking too long? <span style="color:rgba(127,192,255,0.6); text-decoration:underline;">start over</span></div>
    </div>
  </div>`;
}
...
function errorHtml(refCode: string): string {
  return `<div style="${FRAME_OUTER}">
    ...
    <div data-act="home" style="position:relative; z-index:6; padding:34px 16px 2px; flex:none;"><div style="width:36px; height:36px; border-radius:50%; background:rgba(244,247,250,0.05); border:1px solid rgba(244,247,250,0.08); display:flex; align-items:center; justify-content:center; cursor:pointer;"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="rgba(244,247,250,0.6)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg></div></div>
    <div style="position:relative; z-index:2; flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:0 30px; text-align:center;">
      <div style="position:relative; width:210px; height:200px; display:flex; align-items:center; justify-content:center; margin-bottom:8px;">
        ...
        <div style="position:relative; width:160px; height:150px; animation:erFloat 4.6s ease-in-out infinite;">
          ...
          <div style="position:absolute; left:50%; top:50%; transform:translate(-50%,-50%); width:132px; height:132px; background:linear-gradient(155deg,#4aa0f0,#2775CA 60%,#1c5697); animation:erSquish 5s ease-in-out infinite; box-shadow:0 18px 36px rgba(6,14,24,0.5), inset 0 6px 14px rgba(255,255,255,0.32), inset 0 -8px 18px rgba(13,40,72,0.5); display:flex; align-items:center; justify-content:center;">
            ...
            <div style="position:absolute; top:38px; left:34px; width:18px; height:5px; border-radius:999px; background:#0B1622; transform:rotate(-15deg);"></div>
            <div style="position:absolute; top:38px; right:34px; width:18px; height:5px; border-radius:999px; background:#0B1622; transform:rotate(15deg);"></div>
            <div style="display:flex; gap:22px; margin-top:2px;"><div style="width:15px; height:18px; border-radius:50%; background:#0B1622; animation:erBlink 5s infinite;"></div><div style="width:15px; height:18px; border-radius:50%; background:#0B1622; animation:erBlink 5s infinite;"></div></div>
            <div style="position:absolute; bottom:40px; left:50%; transform:translateX(-58%);"><svg width="30" height="10" viewBox="0 0 30 10" fill="none" stroke="#0B1622" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6 H17 Q23 6 26 3"></path></svg></div>
      ...
      <h1 style="font-family:'Clash Display','General Sans',sans-serif; font-weight:600; font-size:42px; letter-spacing:-1.2px; margin:8px 0 0; color:#F4F7FA;">that didn't take.</h1>
      <p style="font-family:'General Sans',sans-serif; font-weight:400; font-size:14.5px; line-height:1.55; color:rgba(244,247,250,0.55); max-width:310px; margin:14px 0 0; text-wrap:pretty;">something hiccuped on the way to your wallet — no harm done, nothing was charged. let's try again.</p>
    </div>
    <div style="position:relative; z-index:6; flex:none; padding:8px 26px calc(20px + env(safe-area-inset-bottom));">
      ...
      <div style="text-align:center; margin-top:14px;"><span data-act="email" style="font-family:'General Sans',sans-serif; font-weight:500; font-size:14px; color:rgba(244,247,250,0.5); cursor:pointer;">use email instead</span></div>
      <div style="text-align:center; margin-top:16px;"><span style="font-family:'Space Mono',monospace; font-size:10px; letter-spacing:.5px; color:rgba(244,247,250,0.22);">ref: ${refCode}</span></div>
    </div>
  </div>`;
}
